...
class CheckableComboBox(QtWidgets.QComboBox):
    # adapted from: https://gis.stackexchange.com/questions/350148/qcombobox-multiple-selection-pyqt5
    ...
    def addItem(self, text, is_checked=False, data=None):
        ...
        item.setData(
            QtCore.Qt.Unchecked if not is_checked else QtCore.Qt.Checked,
